            ...
            <div className="px-4 space-y-5">
                ...
                <div>
                    ...
                    <div className="relative flex items-center rounded-md shadow-sm ">
                        ...
                        <input
                            id="price"
                            className="pl-7 py-2 px-4 border border-transparent appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                            type="text"
                            placeholder="0.00"
                        />
